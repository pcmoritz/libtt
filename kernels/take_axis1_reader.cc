...
constexpr uint32_t INPUT_AXIS1 = TAKE_AXIS1_INDEX;
constexpr uint32_t OUTPUT_ROWS = TAKE_AXIS1_OUTPUT_ROWS;
constexpr uint32_t OUTPUT_COLS = TAKE_AXIS1_OUTPUT_COLS;
constexpr uint32_t INPUT_TILE_ROWS = TAKE_AXIS1_INPUT_TILE_ROWS;
constexpr uint32_t INPUT_TILES_PER_ROW = TAKE_AXIS1_INPUT_TILES_PER_ROW;
constexpr uint32_t OUTPUT_TILE_ROWS = TAKE_AXIS1_OUTPUT_TILE_ROWS;
constexpr uint32_t OUTPUT_TILES_PER_ROW = TAKE_AXIS1_OUTPUT_TILES_PER_ROW;
using Element = TAKE_AXIS1_ELEMENT_TYPE;
...
void kernel_main() {
  ...
  for (uint32_t tile = 0; tile < output_tile_count; ++tile) {
    ...
    uint32_t col_count = tile_extent(OUTPUT_COLS, output_col_base, TILE_C);
    ...
    for (uint32_t row = 0; row < row_count; ++row) {
      uint32_t input_batch = output_row_base + row;
      uint32_t input_tile_row = INPUT_AXIS1 / TILE_R;
      uint32_t source_row = INPUT_AXIS1 % TILE_R;
